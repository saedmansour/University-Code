 ...
 *		linkedListGetCurrent			- gets pointer to the current list node.
 ...
 *              linkedListFind                  - searches for an element from the current element.
 *              linkedListFilter                - creates a filtered copy of the list according to given predicate.
 ...
 *
 * Description:
 *      finds the first element, matching toFind, starting from the current
