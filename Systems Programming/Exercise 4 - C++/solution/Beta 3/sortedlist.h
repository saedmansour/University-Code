...
{
	// didn't use removeCurrent because
	// this is just delets everything
	// without adjusting list so it's quicker
	// and less possibilities for run-time error
	node<T>* currentNode;
